...
class TestFastFilter(unittest.TestCase):
    ...
    def test_filter_initialization(self):
        ...
        custom_filter = FastFilter(threshold=0.5, max_workers=2, lightweight_model="custom-model")
    ...
    def test_threshold_filtering(self):
        ...
        high_results = high_threshold_filter.filter_batch(self.test_contents, self.query)
